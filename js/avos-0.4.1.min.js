!function(t) {
    t.AV = t.AV || {}, t.AV.VERSION = "js0.4.0"
}(this), function() {
    var t = this, e = t._, n = {}, i = Array.prototype, r = Object.prototype, s = Function.prototype, a = i.push, o = i.slice, u = i.concat, c = r.toString, l = r.hasOwnProperty, h = i.forEach, d = i.map, f = i.reduce, p = i.reduceRight, _ = i.filter, m = i.every, v = i.some, g = i.indexOf, b = i.lastIndexOf, y = Array.isArray, w = Object.keys, A = s.bind, O = function(t) {
        return t instanceof O ? t : this instanceof O ? void(this._wrapped = t) : new O(t)
    };
    "undefined" != typeof exports ? ("undefined" != typeof module && module.exports && (exports = module.exports = O), exports._ = O) : t._ = O, O.VERSION = "1.4.4";
    var x = O.each = O.forEach = function(t, e, i) {
        if (null != t)
            if (h && t.forEach === h)
                t.forEach(e, i);
                ...
                for (var a in t)
                    if (O.has(t, a) && e.call(i, t[a], a, t) === n)
                        return 
    };
    O.map = O.collect = function(t, e, n) {
        var i = [];
        return null == t ? i : d && t.map === d ? t.map(e, n) : (x(t, function(t, r, s) {
    ...
    O.reduce = O.foldl = O.inject = function(t, e, n, i) {
        ...
        if (null == t && (t = []), f && t.reduce === f)
            return i && (e = O.bind(e, i)), r ? t.reduce(e, n) : t.reduce(e);
        ...
        if (null == t && (t = []), p && t.reduceRight === p)
            return i && (e = O.bind(e, i)), r ? t.reduceRight(e, n) : t.reduceRight(e);
        var s = t.length;
        if (s!==+s) {
            var a = O.keys(t);
            s = a.length
    ...
    var E = O.some = O.any = function(t, e, i) {
        e || (e = O.identity);
        var r=!1;
    ...
    O.contains = O.include = function(t, e) {
        return null == t?!1 : g && t.indexOf === g?-1 != t.indexOf(e) : E(t, function(t) {
            return t === e
        })
    }, O.invoke = function(t, e) {
        var n = o.call(arguments, 2), i = O.isFunction(e);
        ...
        if (!e && O.isArray(t) && t[0] ===+ t[0] && t.length < 65535)
    ...
    O.groupBy = function(t, e, n) {
        ...
        return t ? O.isArray(t) ? o.call(t) : t.length ===+ t.length ? O.map(t, O.identity) : O.values(t) : []
    }, O.size = function(t) {
    ...
    var N = function(t, e, n) {
        return x(t, function(t) {
            O.isArray(t) ? e ? a.apply(n, t) : N(t, e, n) : n.push(t)
        }), n
    };
    O.flatten = function(t, e) {
        return N(t, e, [])
    }, O.without = function(t) {
        return O.difference(t, o.call(arguments, 1))
    }, O.uniq = O.unique = function(t, e, n, i) {
        O.isFunction(e) && (i = n, n = e, e=!1);
        var r = n ? O.map(t, n, i): t, s = [], a = [];
        return x(r, function(n, i) {
            (e ? i && a[a.length - 1] === n : O.contains(a, n)) || (a.push(n), s.push(t[i]))
        }), s
    }, O.union = function() {
        ...
        for (var t = o.call(arguments), e = O.max(O.pluck(t, "length")), n = new Array(e), i = 0; e > i; i++)
            n[i] = O.pluck(t, "" + i);
        return n
        ...
        if (n) {
            if ("number" != typeof n)
                return i = O.sortedIndex(t, e), t[i] === e ? i : - 1;
        ...
        for (var i = Math.max(Math.ceil((e - t) / n), 0), r = 0, s = new Array(i); i > r;)
            s[r++] = t, t += n;
        return s
    }, O.bind = function(t, e) {
        if (t.bind === A && A)
            return A.apply(t, o.call(arguments, 1));
        ...
        var e = o.call(arguments, 1);
        return 0 === e.length && (e = O.functions(t)), x(e, function(e) {
            t[e] = O.bind(t[e], t)
        }), t
    }, O.memoize = function(t, e) {
        var n = {};
        return e || (e = O.identity), function() {
        ...
        return O.delay.apply(O, [t, 1].concat(o.call(arguments, 1)))
        ...
        var e = [];
        for (var n in t)
            O.has(t, n) && (e[e.length] = n);
        return e
    }, O.values = function(t) {
        var e = [];
        for (var n in t)
            O.has(t, n) && e.push(t[n]);
        return e
    }, O.pairs = function(t) {
        var e = [];
        for (var n in t)
            O.has(t, n) && e.push([n, t[n]]);
        return e
    }, O.invert = function(t) {
        var e = {};
        for (var n in t)
    ...
    }), "function" != typeof/./ && (O.isFunction = function(t) {
    ...
    I.unescape = O.invert(I.escape);
    var U = {
        escape: new RegExp("[" + O.keys(I.escape).join("") + "]", "g"),
        unescape: new RegExp("(" + O.keys(I.unescape).join("|") + ")", "g")
    };
    O.each(["escape", "unescape"], function(t) {
        O[t] = function(e) {
            return null == e ? "" : ("" + e).replace(U[t], function(e) {
                return I[t][e]
            })
        }
        ...
        x(O.functions(t), function(e) {
            var n = O[e] = t[e];
            O.prototype[e] = function() {
                var t = [this._wrapped];
                return a.apply(t, arguments), V.call(this, n.apply(O, t))
            }
        })
    };
    var T = 0;
    ...
    O.template = function(t, e, n) {
        ...
        var r = new RegExp([(n.escape || P).source, (n.interpolate || P).source, (n.evaluate || P).source].join("|") + "|$", "g"), s = 0, a = "__p+='";
    ...
    O.mixin(O), x(["pop", "push", "reverse", "shift", "sort", "splice", "unshift"], function(t) {
        var e = i[t];
        O.prototype[t] = function() {
            var n = this._wrapped;
            return e.apply(n, arguments), "shift" != t && "splice" != t || 0 !== n.length || delete n[0], V.call(this, n)
        }
    ...
    if ("undefined" != typeof exports && exports._) {
        e._ = exports._.noConflict();
        try {
            e.localStorage = require("localStorage")
        } catch (n) {
            e.localStorage = require("./localStorage.js").localStorage
        }
        e.XMLHttpRequest = require("xmlhttprequest").XMLHttpRequest, exports.AV = e
    } else 
        e._ = _.noConflict(), "undefined" != typeof localStorage && (e.localStorage = localStorage), "undefined" != typeof XMLHttpRequest && (e.XMLHttpRequest = XMLHttpRequest);
    "undefined" != typeof $ && (e.$ = $);
    var i = function() {}, r = function(t, n, r) {
        var s;
        return s = n && n.hasOwnProperty("constructor") ? n.constructor : function() {
            t.apply(this, arguments)
        }, e._.extend(s, t), i.prototype = t.prototype, s.prototype = new i, n && e._.extend(s.prototype, n), r && e._.extend(s, r), s.prototype.constructor = s, s.__super__ = t.prototype, s
    };
    e.serverURL = "https://cn.avoscloud.com", "undefined" != typeof process && process.versions && process.versions.node && (e._isNode=!0), e.initialize = function(t, n, i) {
        if (i)
            throw "AV.initialize() was passed a Master Key, which is only allowed from within Node.js.";
        e._initialize(t, n, i)
    }, e._initialize = function(t, n, i) {
        e.applicationId = t, e.applicationKey = n, e.masterKey = i, e._useMasterKey=!1
    }, e._isNode && (e.initialize = e._initialize, e.Cloud = e.Cloud || {}, e.Cloud.useMasterKey = function() {
        e._useMasterKey=!0
    }), e.useAVCloudCN = function() {
        e.serverURL = "https://cn.avoscloud.com"
    }, e.useAVCloudUS = function() {
        e.serverURL = "https://us.avoscloud.com"
        ...
        }, c.open(t, n, !0), c.setRequestHeader("Content-Type", "text/plain"), e._isNode && c.setRequestHeader("User-Agent", "AV/" + e.VERSION + " (NodeJS " + process.versions.node + ")"), c.send(i), o._thenRunCallbacks(a)
        ...
        if ("batch" !== t && "classes" !== t && "files" !== t && "functions" !== t && "login" !== t && "push" !== t && "search/select" !== t && "requestPasswordReset" !== t && "requestEmailVerify" !== t && "requestMobilePhoneVerify" !== t && "requestLoginSmsCode" !== t && "verifyMobilePhone" !== t && "requestSmsCode" !== t && "verifySmsCode" !== t && "users" !== t && "qiniu" !== t && "statuses" !== t && "subscribe/statuses/count" !== t && "subscribe/statuses" !== t&&!/users\/[^\/]+\/friendship\/[^\/]+/.test(t))
            throw "Bad route: '" + t + "'.";
        var a = e.serverURL;
        "/" !== a.charAt(a.length - 1) && (a += "/"), a += "1.1/" + t, n && (a += "/" + n), i && (a += "/" + i), "users" !== t && "classes" !== t || "PUT" !== r ||!s._fetchWhenSave || (delete s._fetchWhenSave, a += "?new=true"), s = e._.clone(s || {}), "POST" !== r && (s._method = r, r = "POST"), s._ApplicationId = e.applicationId, s._ApplicationKey = e.applicationKey, e._useMasterKey && (s._MasterKey = e.masterKey), s._ClientVersion = e.VERSION, s._InstallationId = e._getInstallationId();
        ...
        if ("Pointer" === n.__type) {
            var r = n.className, s = e.Object._create(r);
    ...
    var t = this, e = t.AV || (t.AV = {}), n = /\s+/, i = Array.prototype.slice;
    e.Events = {
        on: function(t, e, i) {
            var r, s, a, o, u;
            if (!e)
    ...
    e.GeoPoint = function(t, i) {
        ...
        if ( - 90 > t)
            throw "AV.GeoPoint latitude " + t + " < -90.0.";
        if (t > 90)
            throw "AV.GeoPoint latitude " + t + " > 90.0.";
        if ( - 180 > e)
            throw "AV.GeoPoint longitude " + e + " < -180.0.";
        if (e > 180)
            throw "AV.GeoPoint longitude " + e + " > 180.0."
    ...
    e.ACL = function(t) {
        ...
        if (t instanceof e.Role && (t = t.getName()), n.isString(t))
            return void this.setReadAccess("role:" + t, i);
        throw "role must be a AV.Role or a String"
    }, e.ACL.prototype.setRoleWriteAccess = function(t, i) {
        if (t instanceof e.Role && (t = t.getName()), n.isString(t))
            return void this.setWriteAccess("role:" + t, i);
        throw "role must be a AV.Role or a String"
    }
}(this), function(t) {
    t.AV = t.AV || {};
            ...
            var r = this, s = function(t) {
                if (t instanceof e.Object) {
                    ...
                    if (r._targetClassName || (r._targetClassName = t.className), r._targetClassName !== t.className)
                        throw "Tried to create a AV.Relation with 2 different types: " + r._targetClassName + " and " + t.className + ".";
                    return t.id
                }
                return t
            };
    ...
    }, e.Relation.reverseQuery = function(t, n, i) {
        var r = new e.Query(t);
    ...
    var e = t.AV, n = e._, i = function(t) {
        ...
        return e.length = Math.ceil(t.length / 3), n.times(e.length, function(n) {
            var r = t[3 * n], s = t[3 * n + 1] || 0, a = t[3 * n + 2] || 0, o = 3 * n + 1 < t.length, u = 3 * n + 2 < t.length;
            e[n] = [i(r>>2 & 63), i(r<<4 & 48 | s>>4 & 15), o ? i(s<<2 & 60 | a>>6 & 3): "=", u ? i(63 & a): "="].join("")
        }), e.join("")
    }, s = {
        ...
        return r.onloadend = function() {
            if (2 !== r.readyState)
                return void i.reject(new e.Error( - 1, "Error reading file."));
            var t = r.result, s = /^data:([^;]*);base64,(.*)$/.exec(t);
            return s ? void i.resolve(s[2], n || s[1]) : void i.reject(new e.Error( - 1, "Unable to interpret data URL: " + t))
        }, r.readAsDataURL(t), i
    };
    e.File = function(t, i, o) {
        this._name = t;
        var u = e.User.current();
        this._metaData = {
        ...
        if (this._guessedType = l, n.isArray(i))
            this._source = e.Promise.as(r(i), l), this._metaData.size = i.length;
        else if (i && i.base64)
            this._source = e.Promise.as(i.base64, l);
        else if ("undefined" != typeof File && i instanceof File)
            this._source = a(i, o);
        else if (e._isNode && Buffer.isBuffer(i))
            this._source = e.Promise.as(i.toString("base64")), this._metaData.size = i.length;
        else if (n.isString(i))
            throw "Creating a AV.File from a String is not yet supported."
    }, e.File.withURL = function(t, n, i, r) {
        if (!t ||!n)
            throw "Please provide file name and url";
        var s = new e.File(t, null, r);
        if (i)
            for (var a in i)
        ...
        thumbnailURL: function(t, e, n, i, r) {
            if (!this.url())
                throw "Invalid url.";
            if (!t ||!e || 0 >= t || 0 >= e)
            ...
            r = r || "png";
            var s = i ? 2: 1;
            return this.url() + "?imageView/" + s + "/w/" + t + "/h/" + e + "/q/" + n + "/format/" + r
        },
        size: function() {
        ...
        destroy: function(t) {
            if (!this.id)
                return e.Promise.error("The file id is not eixsts.")._thenRunCallbacks(t);
            var n = e._request("files", null, this.id, "DELETE");
        ...
        save: function(t) {
            ...
            if (!n._previousSave)
                if (n._source)
                    if (e._isNode) {
                        var i = require("qiniu");
                        n._previousSave = n._source.then(function(t, i) {
                            var r = function() {
                                return Math.floor(65536 * (1 + Math.random())).toString(16).substring(1)
                            }, s = r() + r() + r() + r(), a = {
                                key: s,
                            ...
                            return n._metaData.mime_type = i, n._qiniu_key = s, n._base64 = t, e._request("qiniu", null, null, "POST", a)
                        }).then(function(t) {
                            n._url = t.url, n._bucket = t.bucket, n.id = t.objectId;
                            var r = t.token, s = new e.Promise, a = new i.io.PutExtra;
                            n._metaData.mime_type && (a.mimeType = n._metaData.mime_type);
                            var o = new Buffer(n._base64, "base64");
                            return i.io.put(r, n._qiniu_key, o, a, function(t) {
                                delete n._qiniu_key, delete n._base64, t ? (s.reject(t), n.destroy()) : s.resolve(n)
                            }), s
                        })
                    } else 
                        n._previousSave = n._source.then(function(t, i) {
                            ...
                            return n._name = t.name, n._url = t.url, n.id = t.objectId, t.size && (n._metaData.size = t.size), n
                        });
                    ...
                    n._previousSave = e._request("files", n._name, null, "POST", r).then(function(t) {
                        return n._name = t.name, n._url = t.url, n.id = t.objectId, t.size && (n._metaData.size = t.size), n
                    })
                }
            return n._previousSave._thenRunCallbacks(t)
        }
    }
}(this), function(t) {
    t.AV = t.AV || {};
    ...
    e.Object = function(t, i) {
        ...
        if (r && (t = n.extend({}, r, t)), i && i.collection && (this.collection = i.collection), this._serverData = {}, this._opSetQueue = [{}
        ], this.attributes = {}, this._hashedJSON = {}, this._escapedAttributes = {}, this.cid = n.uniqueId("c"), this.changed = {}, this._silent = {}, this._pending = {}, !this.set(t, {
            silent: !0
        }))
        ...
        escape: function(t) {
            ...
            return r = e._isNullOrUndefined(s) ? "" : n.escape(s.toString()), this._escapedAttributes[t] = r, r
        },
        has: function(t) {
        ...
        save: function(t, i, r) {
            ...
            d._refreshCache();
            var f = [], p = [];
            return e.Object._findUnsavedChildren(d.attributes, f, p), f.length + p.length > 0 ? e.Object._deepSaveAsync(this.attributes, d).then(function() {
                return d.save(null, o)
            }, function(t) {
                return e.Promise.error(t)._thenRunCallbacks(o, d)
        ...
        t.forEach(function(t) {
            ...
            s ? (r = t.id, s=!1) : r = r + "," + t.id
        });
        var a = e._request("classes", i, r, "DELETE");
        ...
        e._traverse(t, function(t) {
            return t instanceof e.Object ? (t._refreshCache(), void(t.dirty() && n.push(t))) : t instanceof e.File ? void(t.url() || i.push(t)) : void 0
        })
        ...
        var r = [], s = [];
        e.Object._findUnsavedChildren(t, r, s), i && (r = n.filter(r, function(t) {
            return t != i
        }));
        var a = e.Promise.as();
        n.each(s, function(t) {
        ...
        return a.then(function() {
            return e.Promise._continueWhile(function() {
                ...
                if (e._arrayEach(u, function(e) {
                    return t.length > 20 ? void i.push(e) : void(e._canBeSerialized() ? t.push(e) : i.push(e))
                }), u = i, 0 === t.length)
                ...
                return e._arrayEach(t, function(t) {
                    ...
                    return e._request("batch", null, null, "POST", {
                        requests: n.map(t, function(t) {
                            var e = t._getSaveJSON(), n = "POST", i = "/1.1/classes/" + t.className;
    ...
    e.Collection = function(t, e) {
        ...
        add: function(t, i) {
            ...
            for (r = 0; a > r; r++)(o = t[r])
                .on("all", this._onModelEvent, this), this._byCid[o.cid] = o, o.id && (this._byId[o.id] = o);
            ...
            if (t = t || e._getValue(this, "events")) {
                ...
                e._objectEach(t, function(e, s) {
                    if (n.isFunction(e) || (e = r[t[s]]), !e)
                        throw new Error('Event "' + t[s] + '" does not exist');
    ...
    e.User = e.Object.extend("_User", {
        ...
        follow: function(t, n) {
            ...
            var i = "string" == typeof t ? t: t.id;
            if (!i)
                throw "Invalid target user.";
            var r = "users/" + this.id + "/friendship/" + i, s = e._request(r, null, null, "POST", null);
            return s._thenRunCallbacks(n)
        },
        unfollow: function(t, n) {
            ...
            if (!i)
                throw "Invalid target user.";
            var r = "users/" + this.id + "/friendship/" + i, s = e._request(r, null, null, "DELETE", null);
            return s._thenRunCallbacks(n)
        },
        ...
        logInWithMobilePhoneSmsCode: function(t, n, i) {
            var r = e.Object._create("_User");
            return r._finishFetch({
                mobilePhoneNumber: t,
                smsCode: n
        ...
        logInWithMobilePhone: function(t, n, i) {
            var r = e.Object._create("_User");
            return r._finishFetch({
                mobilePhoneNumber: t,
                password: n
        ...
        requestPasswordReset: function(t, n) {
            var i = {
                email: t
            }, r = e._request("requestPasswordReset", null, null, "POST", i);
            return r._thenRunCallbacks(n)
        },
        requestEmailVerfiy: function(t, n) {
            var i = {
                email: t
            }, r = e._request("requestEmailVerify", null, null, "POST", i);
            return r._thenRunCallbacks(n)
        },
        requestMobilePhoneVerify: function(t, n) {
            var i = {
                mobilePhoneNumber: t
            }, r = e._request("requestMobilePhoneVerify", null, null, "POST", i);
            return r._thenRunCallbacks(n)
        },
        verifyMobilePhone: function(t, n) {
            var i = e._request("verifyMobilePhone", null, t, "POST", null);
            return i._thenRunCallbacks(n)
        },
        requestLoginSmsCode: function(t, n) {
            var i = {
                mobilePhoneNumber: t
            }, r = e._request("requestLoginSmsCode", null, null, "POST", i);
            return r._thenRunCallbacks(n)
        },
        current: function() {
            ...
            var n = JSON.parse(t);
            return e.User._currentUser.id = n._id, delete n._id, e.User._currentUser._sessionToken = n._sessionToken, delete n._sessionToken, e.User._currentUser.set(n), e.User._currentUser._synchronizeAllAuthData(), e.User._currentUser._refreshCache(), e.User._currentUser._opSetQueue = [{}
            ], e.User._currentUser
        },
    ...
    e.Query = function(t) {
        ...
        _newObject: function(t) {
            return obj = t && t.className ? new e.Object(t.className) : new this.objectClass
        },
        _createRequest: function(t) {
            return e._request("classes", this.className, null, "GET", t || this.toJSON())
        },
        find: function(t) {
            var e = this, i = this._createRequest();
            return i.then(function(t) {
                return n.map(t.results, function(n) {
                    var i = e._newObject(t);
                    return i._finishFetch(e._processResult(n), !0), i
                })
            })._thenRunCallbacks(t)
        },
        ...
        first: function(t) {
            ...
            return r.then(function(t) {
                return n.map(t.results, function(t) {
                    var n = e._newObject();
                    return n._finishFetch(e._processResult(t), !0), n
                })[0]
            })._thenRunCallbacks(t)
        },
        ...
        addAscending: function(t) {
            return this._order ? this._order += "," + t : this._order = t, this
        },
        descending: function(t) {
            return this._order = "-" + t, this
        },
        addDescending: function(t) {
            return this._order ? this._order += ",-" + t : this._order = t, t
        },
        near: function(t, n) {
    ...
    i.FacebookUtils = {
        init: function(t) {
            ...
            if (n = r.clone(t) || {}, n.status && "undefined" != typeof console) {
                ...
                e.call(console, "The 'status' flag passed into FB.init, when set to true, can interfere with AV Facebook integration, so it has been suppressed. Please call FB.getLoginStatus() explicitly if you require this behavior.")
            }
    ...
    e.History.started=!1, n.extend(e.History.prototype, e.Events, {
        ...
        _updateHash: function(t, e, n) {
            if (n) {
                var i = t.toString().replace(/(javascript:|#).*$/, "");
                t.replace(i + "#" + e)
            } else 
                t.hash = e
        }
        ...
        _bindRoutes: function() {
            if (this.routes) {
                ...
                for (var e in this.routes)
                    this.routes.hasOwnProperty(e) && t.unshift([e, this.routes[e]]);
                for (var n = 0, i = t.length; i > n; n++)
                    this.route(t[n][0], t[n][1], this[t[n][1]])
            }
        },
        _routeToRegExp: function(t) {
            return t = t.replace(s, "\\$&").replace(i, "([^/]+)").replace(r, "(.*?)"), new RegExp("^" + t + "$")
        },
    ...
    e.Cloud = e.Cloud || {}, n.extend(e.Cloud, {
        ...
        verifySmsCode: function(t, n) {
            if (!t)
                throw "Missing sms code.";
            var i = e._request("verifySmsCode", t, null, "POST", null);
            return i._thenRunCallbacks(n)
        }
    })
}(this), function(t) {
    ...
    e.Status = function(t, e) {
        return this.data = {}, this.inboxType = "default", this.query = null, t && "object" == typeof t ? this.data = t : (t && (this.data.image = t), e && (this.data.message = e)), this
    }, e.Status.prototype = {
        get: function(t) {
            return this.data[t]
        },
        ...
        send: function(t) {
            ...
            var r = e.Object.createWithoutData("_User", e.User.current().id)._toPointer();
            this.data.source = this.data.source || r, i.data = this.data, i.inboxType = status.inboxType || "default";
            var s = e._request("statuses", null, null, "POST", i), a = this;
            return s.then(function(t) {
                return a.id = t.objectId, a.createdAt = e._parseDate(t.createdAt), a
            })._thenRunCallbacks(t)
        },
        _finishFetch: function(t) {
            this.id = t.objectId, this.createdAt = e._parseDate(t.createdAt), this.updatedAt = e._parseDate(t.updatedAt), this.messageId = t.messageId, delete t.messageId, delete t.objectId, delete t.createdAt, delete t.updatedAt, this.data = t
        }
        ...
        var s = {};
        s.query = i, t.data = t.data || {}, t.data.source = t.data.source || r, s.data = t.data, s.inboxType = t.inboxType || "default";
        ...
        if (!n)
            throw "Invalid target user.";
        var r = "string" == typeof n ? n: n.id;
        if (!r)
            throw "Invalid target user.";
        var s = {};
        s.className = "_User";
        var a = e.Object.createWithoutData("_User", e.User.current().id)._toPointer();
        s.where = {
            objectId: r
        };
        var o = {};
        o.query = s, t.data = t.data || {}, t.data.source = t.data.source || a, o.data = t.data, o.inboxType = "private", t.inboxType = "private";
        var u = e._request("statuses", null, null, "POST", o);
        ...
        t = t || e.User.current();
        var n = "string" != typeof arguments[1] ? arguments[1]: arguments[2], i = "string" != typeof arguments[1] ? "default": arguments[1], r = {};
        r.inboxType = e._encode(i), r.owner = e._encode(t);
        var s = e._request("subscribe/statuses/count", null, null, "GET", r);
        return s._thenRunCallbacks(n)
        ...
        var i = new e.InboxQuery(e.Status);
        return t && (i._owner = t), n && (i._inboxType = n), i
    }
}(this);
